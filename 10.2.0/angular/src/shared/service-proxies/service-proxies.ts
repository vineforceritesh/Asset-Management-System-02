...
@Injectable()
export class AssetsDtoServiceModuleServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getAll(): Observable<AssetsDto[]> {
        let url_ = this.baseUrl + "/api/services/app/AssetsDtoServiceModule/GetAll";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<AssetsDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<AssetsDto[]>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<AssetsDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200.push(AssetsDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return OK
     */
    getById(id: number | undefined): Observable<AssetsDto> {
        let url_ = this.baseUrl + "/api/services/app/AssetsDtoServiceModule/GetById?";
        if (id === null)
    ...
    protected processGetById(response: HttpResponseBase): Observable<AssetsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AssetsDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return OK
     */
    create(body: CreateDto | undefined): Observable<AssetsDto> {
        let url_ = this.baseUrl + "/api/services/app/AssetsDtoServiceModule/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<AssetsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    update(body: UpdateDto | undefined): Observable<AssetsDto> {
        let url_ = this.baseUrl + "/api/services/app/AssetsDtoServiceModule/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<AssetsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
    ...
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/AssetsDtoServiceModule/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
...
export class CreateDto implements ICreateDto {
    ...
    toJSON(data?: any) {
        ...
        data["status"] = this.status;
        data["createdDate"] = this.createdDate ? this.createdDate.format('YYYY-MM-DD') : <any>undefined;
        return data;
    }
